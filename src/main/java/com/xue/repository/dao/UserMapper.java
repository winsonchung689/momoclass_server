...
public interface UserMapper {
    ...
    List<SpaceOrder> getSpaceOrderDate(String date_time,String book_name);

    List<SpaceGoodsList> getSpaceGoodsListByOpenid(String openid);

    List<SpaceGoodsOrder> getSpaceGoodsOrderByOpenid(String openid);

    List<SpaceGoodsOrder> getSpaceGoodsOrderByOpenidQr(String openid_qr);
    ...
    List<Schedule> getScheduleByStudentRepeat(String studio,String campus,String subject,String student_name,Integer is_repeat);

    List<Schedule> getScheduleByStudentDuration(String studio,String campus,Integer dayOfWeek,String duration,String student_name);
    ...
    //获取
    List<Message> getCommentLikeStudent(String student_name,String studio,String campus,String start_date,String end_date,String class_target_bak);
    ...
    List<Arrangement> getArrangementByClassOrdinary(String studio,String dayofweek,String class_number,String duration,String subject,String campus);

    List<Arrangement> getArrangementByClassRepeat(String studio,String class_number,String duration,String subject,String campus);
    ...
    List<SignUp> getSignUpByStudentEndStatus(String student_name,String studio,String subject,String campus,Integer ending_status);
    ...
    int updateLessonPackageCampus(String student_name,String studio,String subject,String campus,String campus_new);
