        ...
        try {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (lessons.size() > 0) {
                    ...
                    List<SignUp> signUpsDuration = dao.getSignUpByDateDuration(student_name, studio, date_time, duration,campus,subject,class_number);
...
//            String md5 = DigestUtils.md5Hex(nick_name + studio);
    ...
    public List getArrangementByRepeatType(String studio, String campus,Integer is_repeat) {
        List<JSONObject> resul_list = new ArrayList<>();
        try {
            List<Arrangement> list = dao.getArrangementByRepeatType(studio,campus,is_repeat);
            for (int i = 0; i < list.size(); i++) {
                JSONObject jsonObject = new JSONObject();
                StringBuffer teachers = new StringBuffer();
                StringBuffer all_teachers = new StringBuffer();
            ...
            if(page == 1){
                if("普通".equals(type)){
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if("全部".equals(campus) || campus.equals(campus_get)){
                            ...
                            if("全部".equals(class_number) || class_number.equals(class_number_get)){
                    ...
                    for(int i = 0;i < list.size();i++){
                        ...
                        String campus_get = cardRecord.getCampus();
                        if("全部".equals(campus) || campus.equals(campus_get)){
