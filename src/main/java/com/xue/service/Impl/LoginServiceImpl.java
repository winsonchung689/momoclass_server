...
//                throw new RuntimeException(e);
    ...
    public int deleteUuids(Integer id, String role,String studio,String openid,String uuid) {
        try {
            ...
            if("课评".equals(class_target_bak) || "环境".equals(class_target_bak) || "课程体系".equals(class_target_bak) || "广告".equals(class_target_bak) || "兼职".equals(class_target_bak) || "图汇展".equals(class_target_bak) || "视频站".equals(class_target_bak) || "新闻".equals(class_target_bak) || "育儿".equals(class_target_bak) || "英语".equals(class_target_bak)){
