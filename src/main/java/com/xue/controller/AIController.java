...
//			横版:1536x1024   竖版:1024x1536  方形:1024x1024
			...
			res = HttpUtil.doPost("https://www.tomimatsu.cn/v1/images/edits", header, params);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return res;
...
//			536x1024：横向   1024x1536：纵向
			...
			res = HttpUtil.doPost("https://www.tomimatsu.cn/v1/images/generations", header, params);
//			System.out.println(res);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
